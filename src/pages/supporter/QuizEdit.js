...
import axiosInstance from "../../config/axiosConfig"; // Dùng axios config chuẩn
import { notify } from '../../utils/toastNotify'; // Dùng notify chuẩn
...
const QuizEdit = () => {
    ...
    useEffect(() => {
        const fetchQuiz = async () => {
            try {
                setLoading(true);
                // Giả định API endpoint giống nhau, backend sẽ check quyền user
                ...
                if (response.data.success && response.data.data) {
                    ...
                    navigate('/supporter/quizzes'); // Điều hướng về trang Supporter
                }
            } catch (err) {
                console.error(err);
    ...
    const saveQuiz = async () => {
        ...
        try {
            ...
            navigate('/supporter/quizzes'); // Điều hướng về danh sách quiz của Supporter
        } catch (error) {
            console.error(error);
                ...
                <header className="bg-white border-b border-gray-200 sticky top-0 z-40">
                    <div className="px-6 py-4 flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            <button
                                onClick={() => navigate('/supporter/quizzes')}
                        ...
                        <button
                            onClick={saveQuiz}
                            disabled={saving}
                            className="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-lg font-medium flex items-center gap-2 transition text-sm shadow-sm disabled:opacity-70"
                        >
                            {saving ? (
                                <>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 outline-none transition"
                                />
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    className="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 outline-none transition cursor-pointer"
                                >
                        ...
                        <div className="lg:col-span-2">
                            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 min-h-[500px] flex flex-col">
                                ...
                                <textarea
                                    ...
                                    rows="3"
                                    className="w-full text-base mb-6 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none resize-none"
                                />
                                    ...
                                    {currentQ.options.map((opt, i) => (
                                        ...
                                        >
                                            ...
                                            <div className={`mt-1 w-5 h-5 rounded-full border flex items-center justify-center shrink-0
                                                ${opt.isCorrect ? 'border-blue-600 bg-blue-600 text-white' : 'border-gray-400 bg-white'}`}>
                                ...
                                <div className="mt-6 pt-4 border-t border-gray-100">
                                    ...
                                    <textarea
                                        ...
                                        rows="2"
                                        className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none resize-none text-sm text-gray-600 bg-gray-50"
                                    />
                                </div>
                            </div>
                        </div>
