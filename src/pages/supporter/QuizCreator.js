...
import axiosInstance from '../../config/axiosConfig'; // chỉnh lại đường dẫn nếu cần
...
const QuizCreator = () => {
    ...
    const deleteQuestion = (idx) => {
        ...
        setConfirmModal({ isOpen: true, type: 'delete_question', targetId: idx, loading: false });
    };
    ...
    const executeConfirmAction = () => {
        ...
        if (type === 'delete_question') {
            ...
            notify.success('Đã gỡ câu hỏi khỏi danh sách!');
        }
                    ...
                    <div className="px-6 py-4 flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600 mt-1">Thiết kế bài kiểm tra trắc nghiệm</p>
                            </div>
                        </div>
                                ...
                                <div className="flex justify-between items-center mb-4 pb-4 border-b border-gray-100">
                                    ...
                                    <span className="text-xs font-medium text-gray-500 bg-gray-100 px-3 py-1.5 rounded-full flex items-center gap-1">
                                        ...
                                        <span className="text-gray-900 font-bold ml-1">
                                            {filledCount}/{quiz.questions.length}
                                        </span>
                                    </span>
                                </div>
                                            ...
                                            <div className="flex-1">
                                                <input
                                                    ...
                                                    className={`w-full bg-transparent outline-none text-sm font-medium placeholder-gray-400 ${
                                                        opt.isCorrect ? 'text-gray-900' : 'text-gray-700'
                                                    }`}
